...
<br>
<tr><th>과목번호</th><th>과목명</th><th>강의시간</th><th>강의장소</th><th>학점</th><th>신청취소</th></tr>
<%
...
mySQL = "select c_id,c_name,c_time,c_addr,c_unit from course where c_id in (select e_c_id from enroll where e_s_id='"+session_id+"')";
